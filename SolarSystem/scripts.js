...
const orbitRotation = document.getElementById("orbitRotation").addEventListener('click', () => {
    setRotationState(rotate);
});

const viewPlanets = document.getElementById("viewPlanets").addEventListener('click', () => {
    setRotationState(!rotate);
});
